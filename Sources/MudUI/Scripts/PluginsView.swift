...
public struct PluginsView: View {
    ...
    private func beginAddLocal() {
            ...
            panel.directoryURL = FileManager.default
                .urls(for: .documentDirectory, in: .userDomainMask).first
            panel.message = "Choose a local plugin — its .xml file, or the folder that contains it. "
...
/// A local plugin row: name + source path, an enable toggle, and a marker
...
/// The detail pane for a local plugin: identity, enabled state, and the
