...
/// plugins folder), a personal plugin is loaded **in place** from the user's
...
/// The persisted set of a world's personal-plugin references — one JSON
...
/// Actor owning a world's personal-plugin references and persisting them to
...
public actor LocalPluginStore {
    ...
    /// On-disk path of this world's personal-plugin document.
    public let url: URL
