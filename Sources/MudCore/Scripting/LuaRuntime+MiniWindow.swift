...
extension LuaRuntime {
    ...
    private nonisolated static let miniWindowHostFunctions: [(String, HostFunction)] = [
        ...
        ("windowMergeImageAlpha", .windowMergeImageAlpha), ("windowTransformImage", .windowTransformImage),
        ("windowImageOp", .windowImageOp), ("windowCreateImage", .windowCreateImage),
        ("windowGetImageAlpha", .windowGetImageAlpha),
    ...
    nonisolated func miniWindowOrRegister(_ function: HostFunction, _ arguments: [LuaValue]) -> [LuaValue] {
        ...
        case .windowCreate, .windowShow, .windowDelete, .windowResize, .windowPosition, .windowSetZOrder,
             ...
             .windowMergeImageAlpha, .windowTransformImage, .windowImageOp, .windowCreateImage,
             .windowGetImageAlpha,
             .windowGradient,
