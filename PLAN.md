...
| Input spell-check toggle (+ no autocorrect); multi-line alias sends; logging retention/per-world; serials keyring/vault + colour | ✅ shipped post-`0.3.0`, unpushed (D-68) |
| Plugin outbound HTTP (`async`) over URLSession | ✅ shipped post-`0.3.0`, unpushed (D-67) |
