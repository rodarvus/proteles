...
mapper colour fix (D-47), shim wins (D-48), and the first Phase-7 features —
Inventory Serials, Session Logging, Notifications (D-49).
...
| Help panel (capture `help`, clickable cross-refs, search, history) | ✅ built (unreleased, D-46) |
...
| Scripts-editor rework, personal-plugin install, leveldb, TTS | ⬜ Phase 7 (plans in docs/plans/) |
